...
func (HyperVHostTestResource) generateHyperVHostRegistrationCert(registrationKeyPtr *string) func(ctx context.Context, client *clients.Client, state *pluginsdk.InstanceState) error {
